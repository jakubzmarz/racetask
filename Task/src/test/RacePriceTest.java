...
public class RacePriceTest
{
    ...
    {
        RacePrice racePrice = new RacePrice(new BigDecimal(0),new BigDecimal(2),new BigDecimal(2), new BigDecimal(2));

        racePrice = PriceModifier.applyLimit(racePrice, BigDecimal.valueOf(5));
        Assertions.assertEquals(BigDecimal.valueOf(0).setScale(2),racePrice.getBasePrice());
    }

    @Test
    public void testSixthScenario()
    {
        RacePrice racePrice = new RacePrice(new BigDecimal(10),new BigDecimal(-4));
    ...
    {
        RacePrice racePrice = new RacePrice(new BigDecimal(-10),new BigDecimal(24));
    ...
    {
        RacePrice racePrice = new RacePrice(new BigDecimal(8),new BigDecimal(1),new BigDecimal(1), new BigDecimal(1));
